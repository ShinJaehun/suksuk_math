...
class DivisionUiStateV2BuilderTest {
    ...
    fun testTwoByOne_46div3_mapsToUiStateV2() {
        ...
        val steps = listOf(
            DivisionPhaseStep(DivisionPhaseV2.InputQuotient, listOf(DivisionCell.QuotientTens)),
            DivisionPhaseStep(DivisionPhaseV2.InputMultiply1, listOf(DivisionCell.Multiply1Tens)),
            DivisionPhaseStep(DivisionPhaseV2.InputSubtract1, listOf(DivisionCell.Subtract1Tens)),
            DivisionPhaseStep(DivisionPhaseV2.InputBringDown, listOf(DivisionCell.Subtract1Ones)),
            DivisionPhaseStep(DivisionPhaseV2.InputQuotient, listOf(DivisionCell.QuotientOnes)),
            DivisionPhaseStep(DivisionPhaseV2.InputMultiply1, listOf(DivisionCell.Multiply2Tens, DivisionCell.Multiply2Ones)),
    ...
    fun testTwoByOne_71div6_mapsToUiStateV2() {
        ...
        val steps = listOf(
            ...
            DivisionPhaseStep(DivisionPhaseV2.InputBringDown, listOf(DivisionCell.Subtract1Ones)),
            DivisionPhaseStep(DivisionPhaseV2.InputQuotient, listOf(DivisionCell.QuotientOnes)),
            DivisionPhaseStep(DivisionPhaseV2.InputMultiply1, listOf(DivisionCell.Multiply2Ones)),
            DivisionPhaseStep(DivisionPhaseV2.InputSubtract1, listOf(DivisionCell.Subtract2Ones)),
            DivisionPhaseStep(DivisionPhaseV2.Complete)
        )
    ...
    fun testTwoByOne_50div3_mapsToUiStateV2() {
        val steps = listOf(
            ...
            DivisionPhaseStep(DivisionPhaseV2.InputQuotient,  listOf(DivisionCell.QuotientOnes)),
            DivisionPhaseStep(DivisionPhaseV2.InputMultiply1, listOf(DivisionCell.Multiply2Tens, DivisionCell.Multiply2Ones)),
            DivisionPhaseStep(DivisionPhaseV2.InputBorrow,    listOf(DivisionCell.BorrowDividendTens), needsBorrow = true),
            DivisionPhaseStep(DivisionPhaseV2.InputSubtract1, listOf(DivisionCell.Subtract2Ones)),
            DivisionPhaseStep(DivisionPhaseV2.Complete)
        )
    ...
    fun testTwoByOne_24div7_mapsToUiStateV2() {
        val steps = listOf(
            DivisionPhaseStep(DivisionPhaseV2.InputQuotient,  listOf(DivisionCell.QuotientOnes)),
            DivisionPhaseStep(DivisionPhaseV2.InputMultiply1, listOf(DivisionCell.Multiply1Tens, DivisionCell.Multiply1Ones)),
    ...
    fun testTwoByTwo_96div12_mapsToUiStateV2() {
        val steps = listOf(
            DivisionPhaseStep(DivisionPhaseV2.InputQuotient,  listOf(DivisionCell.QuotientOnes)),
            DivisionPhaseStep(DivisionPhaseV2.InputMultiply1, listOf(DivisionCell.CarryDivisorTensM1, DivisionCell.Multiply1Ones), needsCarry = true),
            DivisionPhaseStep(DivisionPhaseV2.InputMultiply1, listOf(DivisionCell.Multiply1Tens)),
            DivisionPhaseStep(DivisionPhaseV2.InputSubtract1, listOf(DivisionCell.Subtract1Ones)),
            DivisionPhaseStep(DivisionPhaseV2.Complete)
        )
    ...
    fun testTwoByTwo_68div34_mapsToUiStateV2() {
        val steps = listOf(
            DivisionPhaseStep(DivisionPhaseV2.InputQuotient,  listOf(DivisionCell.QuotientOnes)),
            DivisionPhaseStep(DivisionPhaseV2.InputMultiply1, listOf(DivisionCell.Multiply1Ones)),
            DivisionPhaseStep(DivisionPhaseV2.InputMultiply1, listOf(DivisionCell.Multiply1Tens)),
            DivisionPhaseStep(DivisionPhaseV2.InputSubtract1, listOf(DivisionCell.Subtract1Ones)),
            DivisionPhaseStep(DivisionPhaseV2.Complete)
        )

...
import com.shinjaehun.suksuk.division.PhaseEvaluatorV2Test_TwoByOne.PhaseInputTestCase
...
class PhaseEvaluatorV2Test_ThreeByTwo {
    ...
    val cases = listOf(
        ...
        PhaseInputTestCase(DivisionPhaseV2.InputSubtract1, CellName.Subtract1Tens,     "7", info432x12, 3, listOf("3","6","3"), true),
        PhaseInputTestCase(DivisionPhaseV2.InputSubtract1, CellName.Subtract1Hundreds, "1", info432x12, 4, listOf("3","6","3","7"), true),
        PhaseInputTestCase(DivisionPhaseV2.InputBringDown, CellName.Subtract1Ones,     "2", info432x12, 5, listOf("3","6","3","7","1"), true),
        PhaseInputTestCase(DivisionPhaseV2.InputQuotient,  CellName.QuotientOnes,      "6", info432x12, 6, listOf("3","6","3","7","1","2"), true),
        PhaseInputTestCase(DivisionPhaseV2.InputMultiply2, CellName.Multiply2Ones,     "2", info432x12, 7, listOf("3","6","3","7","1","2","6"), true),
        PhaseInputTestCase(DivisionPhaseV2.InputMultiply2, CellName.Multiply2Tens,     "7", info432x12, 8, listOf("3","6","3","7","1","2","6","2"), true),
        PhaseInputTestCase(DivisionPhaseV2.InputSubtract2, CellName.Subtract2Ones,     "0", info432x12, 9, listOf("3","6","3","7","1","2","6","2","6"), true),
        ...
        PhaseInputTestCase(DivisionPhaseV2.InputMultiply1, CellName.CarryDivisorTensMul1, "1", info864x24, 1, listOf("3"), true),
        ...
        PhaseInputTestCase(DivisionPhaseV2.InputMultiply2, CellName.CarryDivisorTensMul2, "2", info864x24, 8, listOf("3","1","2","7","4","1","4","6"), true),
        PhaseInputTestCase(DivisionPhaseV2.InputMultiply2, CellName.Multiply2Tens,     "14", info864x24, 9, listOf("3","1","2","7","4","1","4","6","2"), true),
        PhaseInputTestCase(DivisionPhaseV2.InputMultiply2, CellName.Multiply2Ones,     "4",  info864x24, 10, listOf("3","1","2","7","4","1","4","6","2","14"), true),
        PhaseInputTestCase(DivisionPhaseV2.InputSubtract2, CellName.Subtract2Ones,     "0",  info864x24, 11, listOf("3","1","2","7","4","1","4","6","2","14","4"), true),

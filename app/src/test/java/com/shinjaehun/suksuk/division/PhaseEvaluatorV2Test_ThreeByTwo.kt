...
class PhaseEvaluatorV2Test_ThreeByTwo {
    ...
    val cases = listOf(
        ...
        // [2] 1차 곱셈 (3 × 2 = 6) - Tens
        PhaseInputTestCase(DivisionPhaseV2.InputMultiply, CellName.Multiply1Tens, "6", 432, 12, 1, listOf("3"), true),
        // [3] 1차 곱셈 (3 × 1 = 3) - Hundreds
        PhaseInputTestCase(DivisionPhaseV2.InputMultiply, CellName.Multiply1Hundreds, "3", 432, 12, 2, listOf("3", "6"), true),
        // [4] 1차 뺄셈 (43 - 36 = 7) - Tens
        PhaseInputTestCase(DivisionPhaseV2.InputSubtract, CellName.Subtract1Tens, "7", 432, 12, 3, listOf("3", "6", "3"), true),
        // [5] 1차 뺄셈 (4 - 3 = 1) - Hundreds
        PhaseInputTestCase(DivisionPhaseV2.InputSubtract, CellName.Subtract1Hundreds, "1", 432, 12, 4, listOf("3", "6", "3", "7"), true),
        // [6] Bring down Ones (2)
        ...
        // [8] 2차 곱셈 (6 × 2 = 12) - Ones
        PhaseInputTestCase(DivisionPhaseV2.InputMultiply, CellName.Multiply2Ones, "2", 432, 12, 7, listOf("3", "6", "3", "7", "1", "2", "6"), true),
        // [9] 2차 곱셈 (6 × 1 = 6) - Tens
        PhaseInputTestCase(DivisionPhaseV2.InputMultiply, CellName.Multiply2Tens, "6", 432, 12, 8, listOf("3", "6", "3", "7", "1", "2", "6", "2"), true),
        // [10] 2차 뺄셈 (12 - 12 = 0) - Ones
        PhaseInputTestCase(DivisionPhaseV2.InputSubtract, CellName.Subtract2Ones, "0", 432, 12, 9, listOf("3", "6", "3", "7", "1", "2", "6", "2", "6"), true),
    )

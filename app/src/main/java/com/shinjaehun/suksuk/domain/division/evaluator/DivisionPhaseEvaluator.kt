...
class DivisionPhaseEvaluator {
    ...
    fun evaluate(
        ...
        val finished = next >= completeIndex ||
                steps.getOrNull(next)?.phase == DivisionPhase.Complete
    ...
    private fun expectedValueForCell(
        ...
        return when (phase) {
            ...
            DivisionPhase.InputBringDown -> when (cell) {
                DivisionCell.Subtract1Ones -> i.bringDownInSubtract1
                else -> null
            }

            DivisionPhase.InputBorrow -> when (cell) {
            ...
            DivisionPhase.InputSubtract1 -> when (cell) {
            ...
            DivisionPhase.PrepareNextOp -> null

            DivisionPhase.InputMultiply2 -> when (cell) {

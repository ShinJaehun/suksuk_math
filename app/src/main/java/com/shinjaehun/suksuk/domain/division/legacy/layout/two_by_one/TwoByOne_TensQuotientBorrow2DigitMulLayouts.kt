...
val twoByOne_TensQuotientBorrow2DigitMulLayouts = listOf(
    ...
    DivisionStepUiLayout(
        ...
        cells = mapOf(
                DivisionCell.BorrowSubtract1Tens to InputCell(divisionCell = DivisionCell.BorrowSubtract1Tens, editable = true, highlight = Highlight.Editing),
                DivisionCell.Subtract1Tens to InputCell(divisionCell = DivisionCell.Subtract1Tens, highlight = Highlight.Related, crossOutColor = CrossOutColor.Pending),
        )
    ),
    DivisionStepUiLayout(
        ...
        cells = mapOf(
                ...
                DivisionCell.Borrowed10Subtract1Ones to InputCell(divisionCell = DivisionCell.Borrowed10Subtract1Ones, editable = false, value = "10", highlight = Highlight.Related),
                DivisionCell.Subtract1Ones to InputCell(divisionCell = DivisionCell.Subtract1Ones, highlight = Highlight.Related),

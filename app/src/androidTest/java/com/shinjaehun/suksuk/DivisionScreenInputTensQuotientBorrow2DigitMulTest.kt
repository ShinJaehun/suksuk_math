...
//        composeTestRule.twoDigitDivByOneDigitCase(DivisionPattern.TensQuotient_Borrow_2DigitMul, 90, 7, listOf("1", "7", "2", "0", "2", "1", "4", "1", "6"))
    ...
    @Test
    fun testPattern_50_div_3() =
        composeTestRule.twoDigitDivByOneDigitCase(DivisionPattern.TensQuotient_Borrow_2DigitMul, 50, 3, listOf("1", "3", "2", "0", "6", "18", "1", "2"))

    @Test
    fun testPattern_70_div_4() =
        composeTestRule.twoDigitDivByOneDigitCase(DivisionPattern.TensQuotient_Borrow_2DigitMul, 70, 4, listOf("1", "4", "3", "0", "7", "28", "2", "2"))

    @Test
    fun testPattern_90_div_7() =
        composeTestRule.twoDigitDivByOneDigitCase(DivisionPattern.TensQuotient_Borrow_2DigitMul, 90, 7, listOf("1", "7", "2", "0", "2", "14", "1", "6"))
}
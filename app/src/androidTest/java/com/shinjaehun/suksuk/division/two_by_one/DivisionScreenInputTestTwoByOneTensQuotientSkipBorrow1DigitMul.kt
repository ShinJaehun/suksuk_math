...
class DivisionScreenInputTestTwoByOneTensQuotientSkipBorrow1DigitMul {
    ...
    fun testPattern_71_div_6() =
        composeTestRule.divisionCase(71, 6, listOf("1", "6", "1", "1", "1", "6", "5"))

    @Test
    fun testPattern_93_div_8() =
        composeTestRule.divisionCase(93, 8, listOf("1", "8", "1", "3", "1", "8", "5"))

    @Test
    fun testPattern_90_div_7() =
        composeTestRule.divisionCase(90, 8, listOf("1", "8", "1", "0", "1", "8", "2"))
}
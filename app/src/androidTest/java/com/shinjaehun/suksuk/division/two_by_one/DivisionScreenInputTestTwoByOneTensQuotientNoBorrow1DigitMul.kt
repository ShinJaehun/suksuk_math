...
class DivisionScreenInputTestTwoByOneTensQuotientNoBorrow1DigitMul {
    ...
    fun testPattern_45_div_4() =
        composeTestRule.divisionCase( 45, 4, listOf("1", "4", "0", "5", "1", "4", "1"))

    @Test
    fun testPattern_57_div_5() =
        composeTestRule.divisionCase(57, 5, listOf("1", "5", "0", "7", "1", "5", "2"))

    @Test
    fun testPattern_84_div_4() =
        composeTestRule.divisionCase(84, 4, listOf("2", "8", "0", "4", "1", "4", "0"))
